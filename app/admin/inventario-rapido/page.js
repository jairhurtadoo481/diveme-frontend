  ...
  const crearProductoNuevo = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        seccion: formNuevo.seccion,
        tipo: formNuevo.tipo || TIPOS_POR_SECCION[formNuevo.seccion][0].valor,
      ...
      setCodigoModelo("");
      setNoEncontrado(false);
      setFormNuevo({ nombre: "", modelo: "", color: "", categoria: "mujer", seccion: "parte_superior", tipo: "", precio: "" });
      setTallaNueva("");
      setCantidadNueva("");
      setImagenNueva(null);
    } catch (err) {
              ...
              <div className="flex flex-col gap-3 mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormNuevo((prev) => ({ ...prev, seccion: e.target.value, tipo: "" }))
                    }
                    className={claseInput}
                  >
                    {SECCIONES.map((s) => (
                ...
                >
                  ...
                  {TIPOS_POR_SECCION[formNuevo.seccion].map((t) => (
